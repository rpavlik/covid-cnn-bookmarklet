 ...
 */
function(t){return"coronavirus-pandemic-intl-"+String(t.getMonth()+1).padStart(2,"0")+"-"+String(t.getDate()).padStart(2,"0")+"-20/"}(t)}(function(){const t=new Date(Date.now());return t.setDate(t.getDate()-1),t}())}();